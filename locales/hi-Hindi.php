...
- Video explantation marketing system long version
    ...
    'guide' => [
      ...
      'howtopay' => [
        ...
        'text1' => 'Dear customer,',
        'text2_1' => 'क्या आप Happiness Guide खरीदना चाहते हैं? बढ़िया, आप ',
        'text2_2' => 'के साथ Happiness Guide खरीद सकते हैं। यह बहुत सरल और आरामदायक है। ',
        'text3' => 'PayU मनी आपको क्रेडिट कार्ड, डेबिट कार्ड, नेट बैंकिंग के साथ भुगतान करने की आजादी देता है।',
        'text4' => 'आप बस "PayU money बटन पर जाएं" और क्लिक करें। आपको चेकआउट प्रक्रिया में रीडायरेक्ट किया जाएगा, जहां आप अपनी पसंदीदा भुगतान विधि का चयन कर सकते हैं।',
        'text5_1' => 'क्या आपका कोई प्रश्न है, या फिर आप चाहते हैं कि एक और भुगतान विकल्प होना चाहिए?',
        'text5_2' => 'बिलकुल, बस हमसे संपर्क करें!',
