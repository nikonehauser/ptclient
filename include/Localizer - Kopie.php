...
class Localizer {
   ...
   * @return $this
   */
  public function setNumberSeparators($decimal, $thousands) {
   ...
   * @return $this
   */
  public function setCurrencySeparators($decimal, $thousands) {
    $this->currencyDecimalSeparator   = $decimal;
    $this->currencyThousandsSeparator = $thousands;
    return $this;
  }
  ...
  public function formatNumber($value, $precision = 2) {
    return number_format($value, $precision, $this->decimalSeparator, $this->thousandsSeparator);
  }
   ...
   * @return string
   */
  public function formatCurrency($value, $precision = 2) {
    return number_format($value, $precision, $this->currencyDecimalSeparator, $this->currencyThousandsSeparator);
  }
  ...
  public function load($strSourcePath, $strCachePath=false, $bolStore=true) {
    ...
    $strLang = $this->init($this -> arrAccepted, $this -> strDefault, $bolStore);
   ...
   * @param  [type] $strLang [description]
   * @return [type]          [description]
   */
  public function store($strLang) {
